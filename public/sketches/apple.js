...
function checkAndUpdateSliders() {
		...
		if (typeof firstLoop === 'undefined') {
				...
				readData({
						"canvases": [
								[0, 35, 0, 16.38352394104004, 14.90057373046875, 0, 54.38352394104004, 0.90057373046875, 0, 90.28125, 8.296875, 0, 108.28125, 39.296875, 0, 103.28125, 77.296875, 0, 86.28125, 115.296875, 0, 61.28125, 144.296875, 0, 22, 143, 0, 0, 127, 0],
								[0, 55, 0, 13, 29, 0, 36, 10, 0, 67, 9, 0, 94, 23, 0, 103, 53, 0, 84, 84, 0, 50, 99, 0, 17, 117, 0, 0, 135, 0],
								[4.28125, 12.984375, 0, 128.28125, 127.984375, 0]
						],
						"sliders": [90, 50, 38.18, 69.99, 20, 70, 0, 85.84],
						"toDrawExtraGeo": [true, true, true, true, true]
				});
				firstLoop = false;
				undo.push(writeData());
		}
...
function setupSliders() {
		...
		canvases.push(new CUI('myCanvas', {
				lineWidth: 20,
				setVec: [0, 35, 0, 16.38352394104004, 14.90057373046875, 0, 54.38352394104004, 0.90057373046875, 0, 98.38352394104004, 11.90057373046875, 0, 117.38352394104004, 47.90057373046875, 0, 109.38352394104004, 83.90057373046875, 0, 82.38352394104004, 116.90057373046875, 0, 56, 144, 0, 22, 143, 0, 0, 127, 0]
		}));
		canvases.push(new CUI('myCanvas2', {
				lineWidth: 20,
				setVec: [0, 55, 0, 13, 29, 0, 36, 10, 0, 67, 9, 0, 94, 23, 0, 103, 53, 0, 84, 84, 0, 50, 99, 0, 17, 117, 0, 0, 135, 0]
		}));
		canvases.push(new CUI('myCanvas3', {
				lineWidth: 3,
				setVec: [20, 20, 0, 130, 130, 0],
				ctrlAmount: 2
		}));
...
applyPreset2 = function (n) {
		...
		case 2:
				...
				readData({
						"canvases": [
								[0, 2.965911865234375, 0, 35.37215995788574, 5.965911865234375, 0, 77.37215995788574, 18.965911865234375, 0, 107.37215995788574, 43.965911865234375, 0, 119.37215995788574, 79.96591186523438, 0, 82.37215995788574, 86.96591186523438, 0, 68.37215995788574, 94.96591186523438, 0, 67.37215995788574, 135.96591186523438, 0, 10.153125000000001, 136.65, 0, 0, 102.45, 0],
								[0, 57, 0, 11.700000000000001, 33.6, 0, 32.4, 16.5, 0, 60.300000000000004, 15.6, 0, 84.60000000000001, 28.2, 0, 92.7, 55.2, 0, 75.60000000000001, 83.10000000000001, 0, 45, 96.60000000000001, 0, 15.3, 112.8, 0, 0, 129, 0],
								[110.37215995788574, 137.49432373046875, 0, 66.37215995788574, 17.49432373046875, 0]
						],
						"sliders": [89.57, 50.74, 53.58, 73.2, 20, 50, 0, 99.99000000000001],
						"toDrawExtraGeo": [true, true, true, false, false]
				});
				break;
		case 3:
				//hamburger
				readData({
						"canvases": [
								[0, 15.15, 0, 84.853125, 20.55, 0, 104.653125, 61.050000000000004, 0, 87.55312500000001, 70.95, 0, 98.353125, 74.55, 0, 99.253125, 96.15, 0, 90.253125, 100.65, 0, 106.453125, 106.95, 0, 91.153125, 131.25, 0, 0, 134.85000000000002, 0],
								[0, 60.15, 0, 16.453125, 34.95, 0, 56.953125, 14.25, 0, 104.653125, 58.35, 0, 118.153125, 124.05, 0, 95.653125, 125.85000000000001, 0, 81.253125, 72.75, 0, 56.953125, 43.050000000000004, 0, 29.053125, 58.35, 0, 0, 115.95, 0],
								[75.28125, 63.1875, 0, 91.28125, 64.1875, 0]
						],
						"sliders": [17.37, 74.25, 67.72, 12.16, 20, 50, 0, 19.38],
		...
		case 4:
				...
				readData({
						"canvases": [
								[0, 75, 0, 12.393, 39.279, 0, 45.19800000000001, 21.054000000000002, 0, 81.648, 27.615000000000002, 0, 105.705, 56.04600000000001, 0, 105.705, 93.22500000000001, 0, 81.648, 122.385, 0, 45.19800000000001, 128.21700000000004, 0, 12.393, 109.992, 0, 0, 75, 0],
								[0, 75, 0, 12.393, 39.279, 0, 45.19800000000001, 21.054000000000002, 0, 81.648, 27.615000000000002, 0, 105.705, 56.04600000000001, 0, 105.705, 93.22500000000001, 0, 81.648, 122.385, 0, 45.19800000000001, 128.21700000000004, 0, 12.393, 109.992, 0, 0, 75, 0],
								[32.28125, 129.1875, 0, 138.28125, 57.1875, 0]
						],
						"sliders": [26.45, 99.99000000000001, 99.99000000000001, 66.52, 20, 50, 0, 51.86],
						"toDrawExtraGeo": [false, false, true]
				});
				break;
		case 5:
				//spaceship
				readData({
						"canvases": [
								[0, 14.25, 0, 20.25, 17.490000000000002, 0, 38.88, 28.02, 0, 61.06065439224244, 55.33219367980958, 0, 108.85065439224243, 65.86219367980956, 0, 108.85065439224243, 82.06219367980957, 0, 60.25065439224244, 92.59219367980957, 0, 38.88, 121.17, 0, 20.25, 131.7, 0, 0, 135.75, 0],
								[0, 14.25, 0, 11.053125, 40.35, 0, 53.28125, 10.5, 0, 32.71065439224243, 60.1921875, 0, 119.28125, 69.5, 0, 59.13, 85.53, 0, 31.900654392242433, 89.35218750000001, 0, 74.28125, 138.5, 0, 13.270654392242433, 105.5521875, 0, 0, 135.75, 0],
								[70.28125, 72.1875, 0, 134.28125, 57.1875, 0]
						],
						"sliders": [17.37, 53.22, 67.72, 19.1, 20, 50, 0, 20],
		...
		case 6:
				...
				readData({
						"canvases": [
								[0, 67.54688186645508, 0, 10.245171546936035, 42.34688186645508, 0, 37.153125, 20.55, 0, 73.24517154693604, 12.646881866455079, 0, 101.05312500000001, 16.950000000000003, 0, 99.34517154693604, 65.74688186645508, 0, 80.44517154693604, 94.54688186645508, 0, 50.745171546936035, 111.64688186645508, 0, 26.445171546936034, 118.84688186645508, 0, 0, 115.24688186645508, 0],
								[0, 20.746875000000003, 0, 41.745171546936035, 19.846875, 0, 81.34517154693604, 19.846875, 0, 106.453125, 20.55, 0, 126.253125, 28.650000000000002, 0, 117.34517154693604, 58.546875, 0, 99.253125, 82.65, 0, 71.44517154693604, 104.446875, 0, 31.845171546936037, 121.546875, 0, 0, 129.64687500000002, 0],
								[37.28125, 64.1875, 0, 76.28125, 118.1875, 0]
						],
						"sliders": [63.99, 76.24, 30.18, 76.09, 20, 50, 0, 47.89],
						"toDrawExtraGeo": [true, true, true, false]
				});
				break;
		case 7:
				...
				readData({
						"canvases": [
								[0, 61.050000000000004, 0, 40.753125000000004, 21.450000000000003, 0, 83.05312500000001, 14.25, 0, 103.753125, 36.75, 0, 101.953125, 71.85000000000001, 0, 67.753125, 81.75, 0, 81.253125, 107.85000000000001, 0, 56.053125, 133.05, 0, 19.153125, 131.25, 0, 0, 91.65, 0],
								[0, 14.25, 0, 13.753125, 18.75, 0, 24.553125, 33.150000000000006, 0, 29.953125, 50.25, 0, 30.853125000000002, 68.25, 0, 30.853125000000002, 85.35000000000001, 0, 30.853125000000002, 102.45, 0, 28.153125, 117.75, 0, 16.453125, 132.15, 0, 0, 135.75, 0],
								[71.28125, 36.1875, 0, 118.28125, 125.1875, 0]
						],
						"sliders": [20.4, 48.92, 67.72, 62.22, 20, 50, 0, 37.37],
		...
		case 8:
				...
				readData({
						"canvases": [
								[0, 34.05, 0, 12.853125, 18.75, 0, 33.553125, 19.65, 0, 47.953125, 39.45, 0, 53.353125, 69.15, 0, 71.353125, 89.85000000000001, 0, 73.153125, 113.25, 0, 56.953125, 132.15, 0, 25.453125, 140.25, 0, 0, 128.55, 0],
								[0, 57, 0, 11.700000000000001, 33.6, 0, 32.4, 16.5, 0, 60.300000000000004, 15.6, 0, 84.60000000000001, 28.2, 0, 92.7, 55.2, 0, 75.60000000000001, 83.10000000000001, 0, 45, 96.60000000000001, 0, 15.3, 112.8, 0, 0, 129, 0],
								[49.28125, 127.1875, 0, 41.28125, 81.1875, 0]
						],
						"sliders": [84.76, 63.63, 20, 56.87, 20, 77.92, 0, 31.22],
						"toDrawExtraGeo": [true, true, true, true, true]
				});
				break;
		case 9:
				...
				readData({
						"canvases": [
								[0, 7.5, 0, 22.5, 11.1, 0, 43.2, 22.8, 0, 58.5, 40.800000000000004, 0, 65.7, 63.300000000000004, 0, 65.7, 86.7, 0, 58.5, 108.3, 0, 43.2, 126.3, 0, 22.5, 138, 0, 0, 142.5, 0],
								[0, 75, 0, 15.3, 30.900000000000002, 0, 55.800000000000004, 8.4, 0, 100.8, 16.5, 0, 130.5, 51.6, 0, 130.5, 97.5, 0, 100.8, 133.5, 0, 55.800000000000004, 140.70000000000002, 0, 15.3, 118.2, 0, 0, 75, 0],
								[31.28125, 30.1875, 0, 52.28125, 62.1875, 0]
						],
						"sliders": [99.99000000000001, 0, 39.11, 74, 20, 0, 50, 20],
						"toDrawExtraGeo": [false, false, true, false]
				});
				break;
		case 10:
				//speaker
				readData({
						"canvases": [
								[0, 7.5, 0, 45, 7.5, 0, 91.28125, 9.5, 0, 126, 16.5, 0, 135, 52.5, 0, 135, 97.5, 0, 126, 133.5, 0, 89.28125, 141.5, 0, 45, 142.5, 0, 0, 142.5, 0],
								[0, 7.5, 0, 22.5, 11.1, 0, 43.2, 22.8, 0, 58.5, 40.800000000000004, 0, 65.7, 63.300000000000004, 0, 65.7, 86.7, 0, 58.5, 108.3, 0, 43.2, 126.3, 0, 22.5, 138, 0, 0, 142.5, 0],
								[41.28125, 21.1875, 0, 43.28125, 103.1875, 0]
						],
						"sliders": [75.04, 62.14, 45.52, 36.62, 20, 0, 50, 59.04],
						"toDrawExtraGeo": [true, true, true, false]
				});
				break;
		case 11:
				...
				readData({
						"canvases": [
								[0, 4.5, 0, 30.28125, 13.5, 0, 53.28125, 32.5, 0, 67.28125, 56.5, 0, 72.28125, 83.5, 0, 74.28125, 112.5, 0, 71.28125, 139.5, 0, 48.28125, 141.5, 0, 21.28125, 141.5, 0, 0, 142.5, 0],
								[0, 7.5, 0, 13.28125, 10.5, 0, 15.28125, 39.5, 0, 51.28125, 41.5, 0, 51.28125, 58.5, 0, 18.28125, 60.5, 0, 12.28125, 92.5, 0, 14.28125, 118.5, 0, 16.28125, 139.5, 0, 0, 142.5, 0],
								[15.28125, 85.1875, 0, 108.28125, 135.1875, 0]
						],
						"sliders": [88, 54.04, 40.85, 73.93, 20, 0, 50, 47.05],
						"toDrawExtraGeo": [true, true, true, false]
				});
				break;
		case 12:
				...
				readData({
						"canvases": [
								[0, 10.296875, 0, 21.28125, 10.296875, 0, 65.28125, 11.296875, 0, 79.28125, 18.296875, 0, 106.28125, 40.296875, 0, 105.28125, 53.296875, 0, 78.28125, 89.296875, 0, 39.28125, 142.296875, 0, 25.28125, 147.296875, 0, 0, 148.296875, 0],
								[0, 7.5, 0, 14.28125, 20.296875, 0, 32.28125, 35.296875, 0, 51.28125, 53.296875, 0, 66.28125, 68.296875, 0, 71.28125, 78.296875, 0, 55.28125, 95.296875, 0, 38.28125, 111.296875, 0, 19.28125, 128.296875, 0, 0, 142.5, 0],
								[118.28125, 129.984375, 0, 107.28125, 63.984375, 0]
						],
						"sliders": [91.58, 50, 38.18, 0, 20, 0, 50, 39.18],
						"toDrawExtraGeo": [true, true, true, false]
				});
				break;
		default:
				readData({
						"canvases": [
								[0, 35, 0, 16.38352394104004, 14.90057373046875, 0, 54.38352394104004, 0.90057373046875, 0, 98.38352394104004, 11.90057373046875, 0, 117.38352394104004, 47.90057373046875, 0, 109.38352394104004, 83.90057373046875, 0, 82.38352394104004, 116.90057373046875, 0, 56, 144, 0, 22, 143, 0, 0, 127, 0],
								[0, 55, 0, 13, 29, 0, 36, 10, 0, 67, 9, 0, 94, 23, 0, 103, 53, 0, 84, 84, 0, 50, 99, 0, 17, 117, 0, 0, 135, 0],
								[20, 20, 0, 130, 130, 0]
						],
						"sliders": [90, 50, 20, 20, 20, 0, 50, 20],
						"toDrawExtraGeo": [true, true, true]
				});
		}
}
